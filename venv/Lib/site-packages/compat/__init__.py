...
try:
    ...
    from django.urls import re_path, include  # pyflakes:ignore
...
if django.VERSION >= (1, 6):
    ...
    class URLValidator(DjangoURLValidator):
        def _init_(self, *args, **kwargs):
            ...
            super(URLValidator, self)._init_(*args, **kwargs)
...
if django.VERSION >= (1, 6):
    ...
    class EmailValidator(DjangoEmailValidator):
        def _init_(self, *args, **kwargs):
            super(EmailValidator, self)._init_(email_re, *args, **kwargs)
...
try:
    ...
    def python_2_unicode_compatible(klass):
        """
        A decorator that defines _unicode_ and _str_ methods under Python 2.
        Under Python 3 it does nothing.
        To support Python 2 and 3 with a single code base, define a _str_ method
        returning text and apply this decorator to the class.
        """
        if '_str' not in klass.__dict_:
            raise ValueError("@python_2_unicode_compatible cannot be applied "
                             "to %s because it doesn't define _str_()." %
                             klass._name_)
        klass._unicode_ = klass._str_
        klass._str_ = lambda self: self._unicode_().encode('utf-8')
        return klass
...
if django.VERSION < (1, 7):
    ...
    pass  # Loading models from _init_ is deprecated from 1.9. Import from compat.models instead
